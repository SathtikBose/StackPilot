...
const Register = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      ...
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-secondary/10 blur-3xl -z-10 rounded-full" />
        
        <h2 className="text-3xl font-bold mb-2 text-center bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">
          Create Account
        </h2>
        <p className="text-gray-400 text-center mb-8">Join StackPilot and optimize your workflow.</p>
